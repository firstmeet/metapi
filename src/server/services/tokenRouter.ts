...
import { getApiKeyUsageRoutingBlockReason } from './accountExtraConfig.js';
...
export class TokenRouter {
  ...
  private getCandidateEligibilityReasons(
    ...
    const apiKeyUsageBlockReason = getApiKeyUsageRoutingBlockReason(candidate.account.extraConfig);
    if (apiKeyUsageBlockReason) {
      reasonParts.push(apiKeyUsageBlockReason);
    }
